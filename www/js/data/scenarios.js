let scenarios = [
    {
        "name": { "en": "Feast for Umôrdhoth", "it": "Il Banchetto di Umôrdhoth", "es": "Festín para Umôrdhoth" },
        "expansion": "Base Game",
        "monsterGropus": [
            ...
            { "name": {"en": "Worshipers of Umôrdhoth", "it": "Adoratori di Umôrdhoth", "es": "Adoradores de Umôrdhoth"}, "monsters": [
    ...
    {
        "name": { "en": "The Pale Lantern", "it": "La Lanterna Pallida", "es": "La Lámpara Mortecina" },
    ...
    },
    {
        ...
        "name": { "en": "Approach of Azathoth", "it": "La Venuta di Azathoth", "es": "La llegada de Azathoth" },
        "expansion": "Base Game",
        "monsterGropus": [
            { "name": {"en": "Monster Deck", "it": "Mazzo dei Mostri", "es": "Mazo de Monstruos"}, "monsters": [
                { "id": "Abyssal Servant", "quantity": 1 },
    ...
    {
        "name": { "en": "Tyrants of Ruin", "it": "I Tiranni della Rovina", "es": "Tiranos de la desolación" },
        "expansion": "Under Dark Waves",
        "monsterGropus": [
            { "name": {"en": "Monster Deck", "it": "Mazzo dei Mostri", "es": "Mazo de Monstruos"}, "monsters": [
    ...
    {
        "name": { "en": "Silence of Tsathoggua", "it": "Il Silenzio di Tsathoggua", "es": "El silencio de Tsathoggua" },
    ...
    {
        "name": { "en": "Shots in the Dark", "it": "Spari nella Notte", "es": "Disparos en la oscuridad" },
        "expansion": "Dead of Night",
        "monsterGropus": [
            { "name": {"en": "Monster Deck", "it": "Mazzo dei Mostri", "es": "Mazo de Monstruos"}, "monsters": [
    ...
    {
        "name": { "en": "Dreams of R'lyeh", "it": "Sogni di R'lyeh", "es": "Sueños de R'lyeh" },
        "expansion": "Under Dark Waves",
        "monsterGropus": [
            { "name": {"en": "Monster Deck", "it": "Mazzo dei Mostri", "es": "Mazo de Monstruos"}, "monsters": [
    ...
    {
        "name": { "en": "Veil of Twilight", "it": "Il Velo del Crepuscolo", "es": "El velo del crepúsculo" },
        "expansion": "Base Game",
        "monsterGropus": [
            { "name": {"en": "Monster Deck", "it": "Mazzo dei Mostri", "es": "Mazo de Monstruos"}, "monsters": [
                { "id": "Altered Beast", "quantity": 2 },
    ...
    {
        "name": { "en": "Ithaqua's Children", "it": "La Progenie di Ithaqua", "es": "La progenie de Ithaqua" },
        "expansion": "Under Dark Waves",
        "monsterGropus": [
            { "name": {"en": "Monster Deck", "it": "Mazzo dei Mostri", "es": "Mazo de Monstruos"}, "monsters": [
